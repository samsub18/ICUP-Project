...
entry_mail = tk.Entry(frame,width=30)
entry_mail.grid(row=1,column=1)

entry_mob = tk.Entry(frame,width=30)
entry_mob.grid(row=2,column=1)

text_workexp = tk.Text(frame,width=30,height=10)
...
pro_exp=tk.Text(frame,width=30,height=10)
pro_exp.grid(row=5+len(languages),column=1)


education = tk.Entry(frame,width=30)
