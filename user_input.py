...
languages = [('Python', v1), ('C++', v2), ('Java', v3), ('JS', v4),
             ('Ruby', v5), ('NodeJs', v6), ('Machine Learning', v7)]
...
tk.Label(frame, text="Full name : ", padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=0)
tk.Label(frame, text="Email id : ", padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=1)
tk.Label(frame, text="Mobile no. : ", padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=2)
tk.Label(frame, text="Work Experience: ", padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=3)
tk.Label(frame, text='Skills & Expertise: ', padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=4)
tk.Label(frame, text='Professional Experience: ', padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=5+len(languages))
tk.Label(frame, text='Education: ', padx=20, pady=10,
         bg='#a1dbcd', font=('Helvetica', 16)).grid(row=13)
...
for lang, val in languages:
    tk.Checkbutton(frame, text=lang, variable=val, justify='center', padx=20, pady=10,
                   bg='#a1dbcd', font=('Helvetica', 13)).grid(row=c, column=1, sticky='W')
    c += 1
...
tk.Button(frame, text='SUBMIT', command=info_get, font=(
    'Arial', 13)).grid(row=16, column=1, sticky='W')
tk.Button(frame, text='QUIT', command=master.quit, font=(
    'Arial', 13)).grid(row=16, column=1, sticky='E')
...
# add addresss field
# isnum() and len==10 for phone number
# use email id checker
# skills needs some input so the dict can't be empty. Perhaps a text field for 'If others, please specify'
